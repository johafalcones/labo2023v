...
PARAM  <- list()
PARAM$experimento  <- "ZZ6920_RUS02"
PARAM$exp_input  <- "HT6510_RUS02"
...
PARAM$semillas  <- c( 350003, 350029, 350033, 350039, 350087 ) #reemplazar por las propias semillas

PARAM$kaggle$envios_desde  <-  9000
PARAM$kaggle$envios_hasta  <- 11500
