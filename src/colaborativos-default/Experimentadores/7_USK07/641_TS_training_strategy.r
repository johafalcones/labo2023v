...
PARAM$train$undersampling  <- 0.7   # primera corrida sin undersampling (1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA)
