...
PARAM  <- list()
PARAM$experimento  <- "ZZ7990_E1V2"
PARAM$exp_input  <- "HT7510_E1"

#Atencion, que cada modelos se procesa con 5 semillas, ajuste a SUS necesidades
PARAM$modelos_rank  <- c(1,2,6,12,24)  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
