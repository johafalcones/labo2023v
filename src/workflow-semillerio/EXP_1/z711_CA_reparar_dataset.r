...
PARAM$metodo  <- "MachineLearning"     #me quedo con MachineLearning segun lo explicado en experimentos colaborativos #valores posibles  "MachineLearning"  "EstadisticaClasica" "Ninguno"
