...
PARAM  <- list()
PARAM$experimento <- "FE7310_E3"

PARAM$exp_input  <- "DR7210_E3"
...
#utilizando los valores de experimentos colaborativos
...
PARAM$CanaritosAsesinos$semilla  <- 101089   # cambiar por la propia semilla
